...
class DetachUserCommand extends Command
{
    protected static $defaultName = 'user:detach';
    protected static $defaultDescription = 'Detach user from group';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        try {
            $response = $this->client->request(
                'PATCH',
                sprintf(
                    'http://server/api/user/detach/%d/%d',
